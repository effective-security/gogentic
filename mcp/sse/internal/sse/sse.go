...
func (t *SSETransport) HandleMessage(msg []byte) error {
	...
	if jsonrpcMsg != nil && t.messageHandler != nil {
...
func (t *SSETransport) Send(msg *transport.BaseJsonRpcMessage) error {
	t.mu.Lock()
	defer t.mu.Unlock()
...
func (t *SSETransport) SetMessageHandler(handler func(*transport.BaseJsonRpcMessage)) {
	t.mu.Lock()
	defer t.mu.Unlock()
